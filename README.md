...
<br>
This application uses the 'python_lib.pl' file available in [this folder] (https://github.com/roboticslab-cseiitg/ProjectTartarus/tree/master/Python_Support)of the Tartarus Github repository.
